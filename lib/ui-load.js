    ...
    fr: {
        translation: {
            ...
            menu: {
                ...
                visualElementsDisplayModeNodes:"Noeuds",
                visualElementsDisplayModeBoxes:"Boîtes",
...
function getMenuItems() {
    return [

        {
            ...
            items: [
                { id: "loadfile", text: i18next.t("menu.loadfile") },
                { id: "savefile", text: i18next.t("menu.savefile") },
                { type: "break" },
                {
                    id: "import", text: i18next.t("menu.import"),
                    items: [
                        { id: "importJArchicg", text: i18next.t("menu.importJArchicg") },
                        { id: "importOEF", text: i18next.t("menu.importOEF") },
                        { id: "importJson", text: i18next.t("menu.importJson") },
                    ]
                },
                { type: "break" },
                {
                    id: "export", text: i18next.t("menu.export"),
                    items: [
                        { id: "exportCSV", text: i18next.t("menu.exportCSV") },
                        { id: "exportOWL", text: i18next.t("menu.exportOWL") }]
                },
                { type: "break" },
                {
                    id: "saveasImage", text: i18next.t("menu.saveasImage"),
                    items: [
                        { id: "saveasImagePNGView", text: i18next.t("menu.saveasImagePNGView") },
                        { id: "saveasImagePNGFull", text: i18next.t("menu.saveasImagePNGFull") },
                        { id: "saveasImageJPGView", text: i18next.t("menu.saveasImageJPGView") },
                        { id: "saveasImageJPGFull", text: i18next.t("menu.saveasImageJPGFull") },
                        { id: "saveasImageSVGView", text: i18next.t("menu.saveasImageSVGView") },
                        { id: "saveasImageSVGFull", text: i18next.t("menu.saveasImageSVGFull") }]
                },
            ]
        },
        {
            type: "menu", id: "compoundGraph", text: i18next.t("menu.compoundGraph"), hidden: true, icon: "fa fa-object-group",
            items: [
                {
                    ...
                    items: [
                        ...
                        { id: "addCompoundForSelected", text: i18next.t("menu.addCompoundForSelected") },
                        { id: "addCompoundForSelected", text: i18next.t("menu.addCompoundForSelected") },
                        { id: "removeSelectedCompound", text: i18next.t("menu.removeSelectedCompound") },
                        { id: "addNestedForSelected", text: i18next.t("menu.addNestedForSelected") },
                        { id: "createNodes", text: i18next.t("menu.createNodes") }
                    ]
                },
                {
                    ...
                    items: [
                        ...
                        { id: "collapseEdgesBetweenSelected", text: i18next.t("menu.collapseEdgesBetweenSelected") },
                        { id: "expandEdgesBetweenSelected", text: i18next.t("menu.expandEdgesBetweenSelected") },
        ...
        {
            type: "menu", id: "compositeGraph", text: i18next.t("menu.compositeGraph"), hidden: true, icon: "fa fa-object-group",
            items: [
                { id: "selectedCompoundToGraph", text: i18next.t("menu.selectedCompoundToGraph") },
                { id: "selectedGraphToCompound", text: i18next.t("menu.selectedGraphToCompound") },
                { id: "createComponent", text: i18next.t("menu.createComponent") },
                { id: "showEdges", text: i18next.t("menu.showEdges") },
                { id: "hideEdges", text: i18next.t("menu.hideEdges") },
            ]
        },
        {
        ...
        { type: 'spacer' },
        {
            type: "menu", id: "parameters", text: i18next.t("menu.parameters"), icon: "fa fa-eye",
            items: [
                {
                    id: 'tc', id: "tooltips", text: i18next.t("menu.tooltips"), expanded: true,
                    items: [
                        { id: "paletteTooltipsOn", text: i18next.t("menu.paletteTooltipsOn") },
                        { id: "paletteTooltipsOff", text: i18next.t("menu.paletteTooltipsOff") },
                    ]
                },
                {
                    id: 'visualElementsDisplayMode', text: i18next.t("menu.visualElementsDisplayMode"),
                    items: [
                        { id: "visualElementsDisplayModeNodes", text: i18next.t("menu.visualElementsDisplayModeNodes") },
                        { id: "visualElementsDisplayModeBoxes", text: i18next.t("menu.visualElementsDisplayModeBoxes") },
                    ]

                }
                ,
                {
                    id: 'visualRelationsDisplayMode', text: i18next.t("menu.visualRelationsDisplayMode"),
                    items: [
                        { id: "visualRelationsDisplayModeEdges", text: i18next.t("menu.visualRelationsDisplayModeEdges") },
                        { id: "visualRelationsDisplayModeBoxes", text: i18next.t("menu.visualRelationsDisplayModeBoxes") },
                    ]

                }
                ,
                {
                    id: 'undoRedo', text: i18next.t("menu.undoRedo"),
                    items: [
                        { id: "undoRedoOn", text: i18next.t("menu.undoRedoOn") },
                        { id: "undoRedoOff", text: i18next.t("menu.undoRedoOff") },
                        { id: "undoRedoClear", text: i18next.t("menu.undoRedoClear") },
                    ]

                }
                ,
                {
                    id: 'archimateRelationshipsRules', text: i18next.t("menu.archimateRelationshipsRules"),
                    items: [
                        { id: "rulesEnforce", text: i18next.t("menu.rulesEnforce") },
                        { id: "rulesRelax", text: i18next.t("menu.rulesRelax") }
                    ]

                }
                ,
                {
                    id: 'URLNavigation', text: i18next.t("menu.URLNavigation"),
                    items: [
                        { id: "URLNavigationChangeMode", text: i18next.t("menu.URLNavigationChangeMode") }
                    ]
        ...
        ,
        {
            type: "menu", id: "tools", text: i18next.t("menu.tools"), icon: "fa fa-eye",
            items: [

            ]
        },
        {
            type: "menu", id: "checker", text: i18next.t("menu.checker"), icon: "fa fa-eye",
            items: [
                { id: "archimateAllowedRelationships", text: i18next.t("menu.archimateAllowedRelationships") }
            ]
        }
        ,
        {
            type: "menu", id: "palettes", text: i18next.t("menu.palettes"), icon: "fa fa-eye",
            items: [

            ]
        },
        {
            type: "menu", id: "archicg", text: i18next.t("menu.archicg"), icon: "fa fa-eye",
            items: [
                { id: "aboutArchiCG", text: i18next.t("menu.aboutArchiCG") }
            ]
        },
